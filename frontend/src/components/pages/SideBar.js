      ...
      return (
        <div className="NavBar">
          ...
          <Menu
            ...
            width={"25%"}
          >
            <Card className="menu-avatar" onClick={this.handleAvatarClick}>
              <Image
                variant="top"
                className="avatarImg"
                style={{
            ...
            <p id="about" className="menu-item" onClick={this.handleConvClick}>
            ...
            <div className={this.state.contOpen}>
              <p
                id="customers"
                className="menu-item"
                onClick={e => this.handleItemClick(e, "/customers")}
              >
                Customers
              </p>
              <p
                ...
                className="menu-item"
                href="/"
                onClick={e => this.handleItemClick(e, "/suppliers")}
              >
                Suppliers
              </p>
            </div>
            ...
            <p
              id="products"
              className="menu-item"
              onClick={e => this.handleItemClick(e, "/products")}
            >
            ...
            <div className={this.state.reviewOpen}>
              <p
                id="productReview"
                className="menu-item"
                onClick={e => this.handleItemClick(e, "/product_review")}
              >
                Product Review
              </p>
              <p
                id="feedbackReview"
                className="menu-item"
                onClick={e => this.handleItemClick(e, "/feedback_review")}
              >
                Feedback Review
              </p>
            </div>
